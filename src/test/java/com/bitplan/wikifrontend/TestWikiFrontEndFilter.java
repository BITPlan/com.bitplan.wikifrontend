...
public class TestWikiFrontEndFilter extends TestBase {
  ...
  public void testRewrite() throws Exception {
    ...
    wiki.setDebug(debug);
    String htmls[] = {
        "<img alt=\"Joker.png\" src=\"/images/wiki/e/ef/Joker.png\" width=\"188\" height=\"277\" /></a>",
        "<object data=\"/images/wiki/5/53/SomePDF2017-DE.pdf\" type=\"application/pdf\" width=\"800\" height=\"800\">\r\n"
            + "<a href=\"/images/wiki/5/53/SomePDF2017-DE.pdf\">load PDF</a>\r\n"
            + "</object>" };
    String expected[] = { "images/wiki/e/ef/Joker.png","images/wiki/5/53/SomePDF2017-DE.pdf" };
    int i = 0;
    for (String html : htmls) {
      html = wiki.fixMediaWikiHtml(html);
      String imageLink = wiki.getSiteurl() + wiki.getScriptPath()
          + expected[i];
      if (debug) {
        LOGGER.log(Level.INFO, "imageLink=" + imageLink);
      }
      assertTrue(imageLink+" should be part of "+html,html.contains(imageLink));
      i++;
    }
  }
  ...
  public void testImageSrcSet() throws Exception {
    ...
    String expected = wiki.getBaseUrl()
        + "/images/wiki/thumb/9/92/800px-CPSA-F_Logo_mit_Text_300dpi.png";
